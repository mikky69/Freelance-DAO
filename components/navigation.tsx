		...
		<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
		  <div className="flex items-center justify-between h-16 md:h-20">
			...
			<div className="flex items-center space-x-2 md:space-x-3 flex-shrink-0">
				...
				<DropdownMenu>
				  ...
				  <DropdownMenuContent align="end" className="w-56 md:w-64 border-[#AE16A7]/30 shadow-2xl rounded-xl backdrop-blur-md" style={{ backgroundColor: "#1D0225" }}>
					...
					<DropdownMenuItem asChild>
					  <Link href="/profile" className="flex items-center"><User className="w-4 h-4 mr-3" />My Profile</Link>
					</DropdownMenuItem>
					<DropdownMenuItem asChild>
					  <Link href="/dashboard" className="flex items-center"><Briefcase className="w-4 h-4 mr-3" />Dashboard</Link>
					</DropdownMenuItem>
					{user?.role === "freelancer" && (
					  <>
						<DropdownMenuItem asChild>
						  <Link href="/reputation" className="flex items-center"><Star className="w-4 h-4 mr-3" />Reputation</Link>
						</DropdownMenuItem>
						<DropdownMenuItem asChild>
						  <Link href="/ai-agents/dashboard" className="flex items-center"><Bot className="w-4 h-4 mr-3" />AI Dashboard</Link>
						</DropdownMenuItem>
					  </>
					)}
					<DropdownMenuItem asChild>
					  <Link href="/settings" className="flex items-center"><Settings className="w-4 h-4 mr-3" />Settings</Link>
					</DropdownMenuItem>
					<DropdownMenuSeparator />
			  ...
			  {isAuthenticated && (
				<Button variant="ghost" size="sm" className="hidden lg:flex text-white hover:bg-gradient-to-r hover:from-[#AE16A7]/20 hover:to-[#FF068D]/20 rounded-xl" onClick={() => setIsSidebarOpen(true)}>
